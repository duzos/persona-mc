...
public class ArseneAnimations {
    ...
    public static final Animation IDLE = Animation.Builder.create(6.183434f).looping()
            .addBoneAnimation("arsene",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            ...
                            new Keyframe(4f, AnimationHelper.createTranslationalVector(11f, 16f, 11f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(5f, AnimationHelper.createTranslationalVector(11f, 14f, 11f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(6f, AnimationHelper.createTranslationalVector(11f, 16f, 11f),
                                    Transformation.Interpolations.CUBIC)))
            .addBoneAnimation("arsene",
            ...
            .addBoneAnimation("left_legs",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            ...
                            new Keyframe(4f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(5f, AnimationHelper.createTranslationalVector(0f, -0.1f, 0f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(6f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.CUBIC)))
            .addBoneAnimation("left_legs",
