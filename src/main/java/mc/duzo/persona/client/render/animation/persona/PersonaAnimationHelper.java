 ...
 * Edited for animating PersonaModels
 *
 * @author duzo
 */
...
public class PersonaAnimationHelper {
	...
	public static void updateAnimation(AnimationState animationState, Animation animation, float animationProgress, float speedMultiplier, PersonaModel model) {
	...
	public static void updateAnimation(AnimationState animationState, Animation animation, float animationProgress, PersonaModel model) {
	...
	private static Optional<ModelPart> getChild(PersonaModel model, String name) {
		return model.getChild(name);
	}

	public static Vector3f getModelPartPivot(PersonaModel model, String name) {
	...
	public static Vector3f getModelPartRotation(PersonaModel model, String name) {
		Optional<ModelPart> optional = getChild(model, name);
		if(optional.isEmpty()) return new Vector3f(0.0F, 0.0F, 0.0F);
